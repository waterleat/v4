...
class FamilySeeder extends Seeder
{
    ...
    public function run(): void
    {
        $families = [
            ...
            ['name' => 'Arum', 'latin' => '??', 'description' => 'The arum family is a large family that includes many tropical ornamental flowering plants that have a distinctive shape, including Anthuriums. The edible members of this family include elephant foot yam, taro, and tania.'],
            ['name' => 'Mallow', 'latin' => '??', 'description' => 'Okra is the only member of the mallow family that is considered a vegetable. However, this same family contains other well-known plants, such as hibiscus and cotton, and is thought to have originated from Africa or South Asia. All members of this family prefer warm tropical growing conditions.'],
            ...
            ['name' => 'Morning-glory', 'latin' => '??', 'description' => 'As you may have guessed, this family includes the ornamental flowering plant, morning-glory, as well as sweet potato, a tuber vegetable that grows well in warm areas.'],
