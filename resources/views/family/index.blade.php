<x-layout>
    ...
    <div class="flex flex-wrap justify-between">
        ...
        <x-layout.index-cards class="w-72 px-4">
            <div class=" text-gray-900 py-1 mr-8 hover:text-gray-700 hover:bg-green-100 transition-all">
                <a href="{{ route('family.show', ['family'=>$family]) }}">
                    <h2 class="text-2xl font-semibold">{{ $family->name }}</h2>
                    <p class=" ">{{ $family->latin }}</p>
                </a>
            </div>
